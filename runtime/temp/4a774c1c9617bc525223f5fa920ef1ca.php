<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"/www/wwwroot/exam/info/app/home/view/index/index.html";i:1688984243;}*/ ?>
<html lang="cn">
<head>
<meta charset="UTF-8">
                    ...
                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                        <fieldset>
                            ...
                            <legend class="container">
                                ...
                                <span class="left">Top Up Account Balance</span>
                                <div class="right" style="">
                                    <a href="<?php echo url('index/record'); ?>" class="btn btn-primary right">Check My Top-up Record </a>
                                </div>
                            </legend>
