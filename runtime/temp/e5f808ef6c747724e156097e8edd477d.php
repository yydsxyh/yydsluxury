<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"/Users/lambor/Desktop/code/app/app/home/view/index/index.html";i:1680798554;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/mate.html";i:1680791436;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/head.html";i:1680791559;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/foot.html";i:1680791177;}*/ ?>
﻿<!doctype html>
<html lang="zh-CN">

<head>
    <title>凤凰联盟-官方网站</title>
...
<body>
    ...
    <div class="container margin-top-big">
        <div class="flip" id="flip">
            <div class="flip-body">
                ...
                <div class="flip-item">
                    <span style="color:#333333;font-family:-apple-system, BlinkMacSystemFont;font-size:16px;background-color:#FFFFFF;">
                        <strong>
                            <span style="color:#000000;">永久网址</span>
                        </strong>
                        &nbsp;
                        <a href="index.html" target="_blank">
                            <span style="font-size:14px;color:#337FE5;">
                                <strong>qiqu168.com</strong>
                            </span>
                        </a>
                        <strong>
                            &nbsp;&nbsp;&nbsp;
                        </strong>
                        <a href="http://qiqu1688.com" target="_blank">
                            <span style="font-size:14px;color:#337FE5;">
                                <strong>qiqu1688.com</strong>
                            </span>
                        </a>
                        <strong>
                            &nbsp;&nbsp;&nbsp;
                        </strong>
                        <a href="http://qiqu16888.com" target="_blank">
                            <span style="font-size:14px;color:#337FE5;">
                                <strong>qiqu16888.com</strong>
                            </span>
                        </a>
                    </span>

                    <img src="__PUBLIC__<?php echo $banner['pic']; ?>" class="img-auto" alt="<?php echo $banner['name']; ?>" />
                    </a>
                </div>
    ...
    <div class="container min-full">
        ...
        <div class="grid">
            <?php if(is_array($hot) || $hot instanceof \think\Collection || $hot instanceof \think\Paginator): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "暂无数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="big-x2 small-x little-x3 padding-top padding-bottom">
        ...
        <h5 class="margin-top-large margin-bottom-big">所有平台</h5>
        <div class="grid">
