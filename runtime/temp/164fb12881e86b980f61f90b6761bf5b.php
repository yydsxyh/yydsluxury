<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/Users/lambor/Desktop/code/app/app/admin/view/banner/index.html";i:1680798308;s:62:"/Users/lambor/Desktop/code/app/app/admin/view/common/head.html";i:1517565830;s:62:"/Users/lambor/Desktop/code/app/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    ...
    <div class="demoTable layui-form">
        ...
        <!-- <a href="<?php echo url('add'); ?>" class="layui-btn" style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i><?php echo lang('add'); ?>Banner</a> -->
        ...
        layui.use(['table','form'], function() {
            ...
            var tableIn = table.render({
                ...
                cols: [[
                    ...
                    {field: 'name', title: '横幅名称', width: 150, align: 'center'},
            ...
            table.on('tool(list)', function(obj) {
                var data = obj.data;
                if (obj.event === 'del'){
                    layer.confirm('您确定要删除该横幅吗？', function(index){
            ...
            $('#delAll').click(function(){
                layer.confirm('确认要删除选中的横幅吗？', {icon: 3}, function(index) {
                    layer.close(index);
