<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"/www/wwwroot/exam/info/app/home/view/index/form.html";i:1688984476;}*/ ?>
<html lang="cn">
<head>
<meta charset="UTF-8">
                    ...
                    <form method="post" enctype="multipart/form-data" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="email" value="<?php echo $data['email']; ?>" placeholder="My Registered Email" id="input-email" class="form-control">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="contact" value="<?php echo $data['contact']; ?>" placeholder="Contact" id="input-contact" class="form-control" style="height: 50px;">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="account_name" value="<?php echo $data['account_name']; ?>" placeholder="My Bank Account Name" id="input-account_name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-3 control-label" for="input-account_no">My Bank Account No.</label>
                                <div class="col-sm-9">
                                    <input type="text" name="account_no" value="<?php echo $data['account_no']; ?>" placeholder="My Bank Account No." id="input-account_no" class="form-control">
                                </div>
                            </div>
                            <div class="form-group ">
                                <label class="col-sm-3 control-label" for="input-reference_number">Reference Number</label>
                                <div class="col-sm-9">
                                    <input type="text" name="reference_number" value="<?php echo $data['reference_number']; ?>" placeholder="Reference Number" id="input-reference_number" class="form-control">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group" id="input-group_amount"><span id="bank_currency" class="input-group-addon">RM</span>
                                        <input type="text" name="amount" value="<?php echo $data['amount']; ?>" placeholder="Amount" id="input-amount" class="form-control" autocomplete="off">
                                    </div>
                                    Amount converted <span id="base_currency_amount"> <?php echo $data['amount']; ?> </span> Points 
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="input-remark">Add Remark About Your Top-up</label>
                                <div class="col-sm-9">
                                    <textarea name="remark" rows="8" style="width: 100%;" placeholder="Add Remark About Your Top-up" id="remark"><?php echo $data['remark']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group date" id="input-group_date">
                                        <input type="text" name="date_paid" value="<?php echo $data['pay_date']; ?>" placeholder="Date Paid" id="input-date_paid" data-date-format="YYYY-MM-DD" class="form-control" readonly>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <?php } ?>
                                    <img src="<?php echo $data['receipt']; ?>" width="40" style="margin:2px; display: block"/>
                                    <input type="hidden" name="file" value="<?php echo $data['receipt']; ?>" id="file">
                                    <input type="hidden" name="receipt_required" value="1">
                                </div>
                        
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label" for="input-remark">Invalid Remark</label>
                                <div class="col-sm-9">
                                    <textarea name="back_remark" rows="8" style="width: 100%;" placeholder="" id="back_remark" readonly><?php echo $data['back_remark']; ?></textarea>
                                </div>
                            </div>
                        </fieldset>
...
<script type="text/javascript">
    var pay_to = "<?php echo $data['pay_to']; ?>"
    $('#pay_to').val(pay_to);
