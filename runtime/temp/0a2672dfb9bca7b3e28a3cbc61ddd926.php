<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"/Users/lambor/Desktop/code/info/app/admin/view/index/index.html";i:1688906108;s:63:"/Users/lambor/Desktop/code/info/app/admin/view/common/head.html";i:1688906090;s:63:"/Users/lambor/Desktop/code/info/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        layui.use('layer',function(){
            ...
            $('#resetp').click(function () {
                layer.prompt({title: '请输入密码并确认', formType: 1}, function(pass, index){
                    layer.close(index);
                    $.post('<?php echo url("update"); ?>', {pass: pass}, function (res) {
                        if (res.code > 0) {
