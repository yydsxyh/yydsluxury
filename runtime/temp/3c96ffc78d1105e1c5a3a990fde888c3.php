<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/www/wwwroot/ishop/home/admin/app/admin/view/index/index.html";i:1619344145;s:61:"/www/wwwroot/ishop/home/admin/app/admin/view/common/head.html";i:1517565830;s:61:"/www/wwwroot/ishop/home/admin/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                ...
                <li class="layui-nav-item">
                    <a href="/index.php" target="_blank"><?php echo lang('home'); ?></a>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;" class="admin-header-user">
                        <img src="__PUBLIC__<?php echo session('avatar'); ?>" class="layui-nav-img" />
            ...
            <ul class="layui-nav admin-header-item-mobile">
                ...
                <li class="layui-nav-item">
                    <a href="<?php echo url('admin/index/logout'); ?>"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lang('logout'); ?></a>
                </li>
            </ul>
        </div>
    </div>
