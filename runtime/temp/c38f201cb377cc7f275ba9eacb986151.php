<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/Users/lambor/Desktop/code/app/app/admin/view/jihua/index.html";i:1680797849;s:62:"/Users/lambor/Desktop/code/app/app/admin/view/common/head.html";i:1517565830;s:62:"/Users/lambor/Desktop/code/app/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    ...
    <div class="demoTable layui-form">
        ...
        <a href="<?php echo url('add'); ?>" class="layui-btn" style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i><?php echo lang('add'); ?>计划</a>
        ...
        layui.use(['table','form'], function() {
            ...
            var tableIn = table.render({
                ...
                cols: [[
                    ...
                    {field: 'title', title: '计划名称', width: 150, align: 'center'},
                    {field: 'url', title: '计划地址', width: 250, align: 'center'},
            ...
            table.on('tool(list)', function(obj) {
                var data = obj.data;
                if (obj.event === 'del'){
                    layer.confirm('您确定要删除该计划吗？', function(index){
            ...
            $('#delAll').click(function(){
                layer.confirm('确认要删除选中的计划吗？', {icon: 3}, function(index) {
                    layer.close(index);
