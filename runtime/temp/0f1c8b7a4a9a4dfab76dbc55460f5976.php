<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"/Users/lambor/Desktop/code/song/app/admin/view/song/form.html";i:1682184554;s:63:"/Users/lambor/Desktop/code/song/app/admin/view/common/head.html";i:1517565830;s:63:"/Users/lambor/Desktop/code/song/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <select name="cate_id" lay-verify="required" ng-model="field.cate_id" ng-options="v.id as v.title for v in group" ng-selected="v.type_id==field.type_id">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="title" ng-model="field.title" lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>歌曲名称" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">歌手</label>
            <div class="layui-input-4">
                <input type="text" name="author" ng-model="field.author" lay-verify="required" placeholder="<?php echo lang('pleaseEnter'); ?>歌手" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">是否新歌</label>
