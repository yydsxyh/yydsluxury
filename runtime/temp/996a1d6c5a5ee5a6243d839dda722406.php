<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"/Users/lambor/Desktop/code/song/app/admin/view/song/index.html";i:1682184734;s:63:"/Users/lambor/Desktop/code/song/app/admin/view/common/head.html";i:1517565830;s:63:"/Users/lambor/Desktop/code/song/app/admin/view/common/foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    ...
    <div class="demoTable layui-form">
        <div class="layui-inline">
            <select name="type_id" lay-filter="type_id" ng-model="type_id" ng-options="v.id as v.title for v in group" ng-selected="v.type_id==field.type_id" id="type_id">
        ...
        <a href="<?php echo url('add'); ?>" class="layui-btn" style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i><?php echo lang('add'); ?>歌曲</a>
        ...
        layui.use(['table','form'], function() {
            ...
            var tableIn = table.render({
                ...
                cols: [[
                    ...
                    {field: 'title', title: '歌曲名称', width: 150, align: 'center'},
                    {field: 'author', title: '歌手', width: 150, align: 'center'},
            ...
            $('#delAll').click(function(){
                layer.confirm('确认要删除选中的应用吗？', {icon: 3}, function(index) {
                    layer.close(index);
