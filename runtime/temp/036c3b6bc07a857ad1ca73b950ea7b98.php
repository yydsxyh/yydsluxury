<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"D:\phpstudy_pro\WWW\order/app/admin\view\product\form.html";i:1618475031;s:57:"D:\phpstudy_pro\WWW\order/app/admin\view\common\head.html";i:1517565830;s:57:"D:\phpstudy_pro\WWW\order/app/admin\view\common\foot.html";i:1517565830;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main layui-anim layui-anim-upbit" ng-app="hd" ng-controller="ctrl">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-4">
                <input type="text" name="special" ng-model="field.special" lay-verify="required|number" placeholder="<?php echo lang('pleaseEnter'); ?>优惠价格" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
