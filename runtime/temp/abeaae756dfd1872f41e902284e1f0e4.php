<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"/Users/lambor/Desktop/code/app/app/home/view/index/contact.html";i:1680799307;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/mate.html";i:1680791436;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/head.html";i:1680791559;s:61:"/Users/lambor/Desktop/code/app/app/home/view/common/foot.html";i:1680791177;}*/ ?>
<!doctype html>
<html lang="zh-CN">
...
<body>
	...
	<div class="container min-full">
		<h5 class="margin-top-large margin-bottom text-center">联系我们</h5>
		...
		<div class="grid">
			...
			<div class="hover-bg big-x6 small-x6 padding-small padding-right-big">
				<div class="media effect-hover moble-app">
					<img src="__PUBLIC__<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>"
						class="icon scale">
					<div class="media-body margin-top-small">
						<strong><?php echo $vo['title']; ?></strong>
						<p class="margin-top">
							<span class="m-show"></span>
							<a href="<?php echo $vo['url']; ?>" class="button button-app radius-large">下载</a>
						</p>
					</div>
				</div>
